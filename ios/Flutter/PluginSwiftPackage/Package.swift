...
// its ephemeral aggregate with the SDK default (13.0/15.0), which is too late
...
let package = Package(
    ...
    dependencies: [
        .package(name: "appcheck", path: "../ephemeral/Packages/.packages/appcheck-1.8.0"),
        ...
        .package(name: "integration_test", path: "../ephemeral/Packages/.packages/integration_test"),
        .package(name: "lib_llama_cpp_ios", path: "../ephemeral/Packages/.packages/lib_llama_cpp_ios"),
        ...
        .package(name: "record_ios", path: "../ephemeral/Packages/.packages/record_ios-2.1.1"),
    ...
    targets: [
        .target(
            ...
            dependencies: [
                ...
                .product(name: "lib-llama-cpp-ios", package: "lib_llama_cpp_ios"),
